<template>
    ...
    <div class="mt-2 flex flex-col rounded-lg border-2 p-4 shadow-lg w-4/6">
        ...
        <p class="mt-2 mb-2 text-justify">
            ...
            <NQuote name="objects" link="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Working_with_objects" 
                summary="Working with Objects - JavaScript | MDN" :chapter="chapterName"
            /> 
            son estructuras de datos que permiten almacenar colecciones de pares 
...
persona.profesion = "Ingeniera"; // Adicion de nueva propiedad
        ...
        <p class="mt-2 mb-2 text-justify">
            ...
            <NQuote name="objetos_de_primera_clase" link="https://developer.mozilla.org/en-US/docs/Glossary/First-class_Function"
                summary="First-class Function - JavaScript | MDN" :chapter="chapterName" />
...
console.log(duplicar(4)); // Salida: 8
        ...
        <SectionTitle :chapter="chapterName" section="Programación oriendatada a objetos" />
        <p class="mt-2 mb-2 text-justify">
            La progrmación orientada a objetos (POO) es un paradigma de programación
            <NQuote name="poo" link="https://developer.mozilla.org/en-US/docs/Glossary/OOP"
                summary="OOP | MDN" :chapter="chapterName" />
            que organiza el 
        ...
        <p class="mt-2 mb-2 text-justify">
            Una clase 
            <NQuote name="clase" link="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Classes"
                summary="Classes - JavaScript | MDN" :chapter="chapterName" />
            es un plano para crear objetos. Define las propiedades y métodos que tendrán 
...
ana.saludar(); // Hola, soy Ana y tengo 30 anios.
        ...
        <p class="mt-2 mb-2 text-justify">
            La herencia
            <NQuote name="herencia" link="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Inheritance_and_the_prototype_chain
                " summary="Inheritance and the prototype chain - JavaScript | MDN" :chapter="chapterName" />
            es un mecanismo que permite que una clase (clase hija) herede propiedades y 
...
juan.trabajar(); // Metodo propio: Juan esta trabajando como desarrollador.
        ...
        <p class="mt-2 mb-2 text-justify">
            ...
            <NQuote name="DOM" link="https://developer.mozilla.org/en-US/docs/Web/API/Document_Object_Model"
                summary="Document Object Model (DOM) - Web APIs | MDN" :chapter="chapterName" />
            es una representación estructurada del documento HTML como un 
...
elementoAEliminar.parentNode.removeChild(elementoAEliminar);
        ...
        <p class="mt-2 mb-2 text-justify">
            El tag <code>button</code> 
            <NQuote name="button" link="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/button"
                summary="The button element | MDN" :chapter="chapterName" />
            en HTML crea un botón interactivo en la página web.
        </p>
        <pre>
            <code class="languaje-html">
                {{ simpleHTMLButton }}
...
boton.style.color = 'white';
        ...
        <p class="mt-2 mb-2 text-justify">
            ...
            <NQuote name="event listeners" link="https://developer.mozilla.org/en-US/docs/Web/API/EventTarget/addEventListener#listener"
                summary="EventTarget.addEventListener() | MDN" :chapter="chapterName" />
            permiten que nuestra página reaccione a acciones del usuario o 
...
actualizarContador();
        ...
        <ul class="ps-5 mt-2 mb-2 text-justify space-y-1 list-disc list-inside">
            <li>Usamos <code>document.getElementById()</code>
                <NQuote name="getElementById()" link="https://developer.mozilla.org/en-US/docs/Web/API/Document/getElementById" 
                    summary="Document.getElementById() | MDN" :chapter="chapterName" />
                para obtener referencias a los elementos HTML.</li>
        ...
        <Bibliography chapter="Objetos y manipulación del DOM" />
    </div>
</template>
...
onMounted(() => {
    useBibliographyStore().registerChapter('Objetos y manipulación del DOM');
})

const chapterName = 'Objetos y manipulación del DOM';
